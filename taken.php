...
<body>
  ...
  <div class="table-container">
    ...
    <tbody>
      ...
      $count = 0;
        $sql = "SELECT * FROM clients WHERE taken = 'Yes' AND returned = 'No'";
        ...
        if(mysqli_num_rows($query) > 0){
          ...
          echo "<tr><td colspan='13' align='center'><b>There are no goods that were taken and not returned.</b></td></tr>";
        }
      ?>
    </tbody>
  </table>
